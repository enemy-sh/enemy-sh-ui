...
export default function ContactForm() {
    ...
    return (
                <Form {...form}>
                    <form id="contact" onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col justify-between bg-white/70 border h-[500px] rounded-lg font-normal p-6 shadow-md md:w-fit w-full">
                    ...
                    <div className="flex flex-col md:flex-row gap-5">
                        ...
                        render={({ field }) => (
                            ...
                            <FormControl>
                                <Input placeholder="enter your first name" {...field} className="rounded-md" />
                            </FormControl>
                            <FormMessage />
                            </FormItem>
                        )}
                        ...
                        render={({ field }) => (
                            ...
                            <FormControl>
                                <Input placeholder="enter your last name" {...field} className="rounded-md" />
                            </FormControl>
                            <FormMessage />
                            </FormItem>
                        )}
